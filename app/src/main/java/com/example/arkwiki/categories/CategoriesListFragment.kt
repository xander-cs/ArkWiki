...
class CategoriesListFragment : Fragment() {
    override fun onCreateView(
        ...
        categories.add(Card("Breeding", "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/a/a3/Eggs.png/revision/latest?cb=20200807154254"))
        ...
        categories.add(Card("Taming", "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/c/cc/Box_o%27_Chocolates.png/revision/latest?cb=20160228212112"))
        categories.add(Card("Tips", "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/5/5f/Magnifying_Glass.png/revision/latest?cb=20220905113952"))
