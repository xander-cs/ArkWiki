...
class DinosaurDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (arguments != null)
        {
            ...
            Glide.with(this).load(image).placeholder(R.drawable.ic_placeholder).into(view.findViewById(R.id.dinosaur_image_detail))
            Glide.with(this).load(dietImage).placeholder(R.drawable.ic_placeholder).into(view.findViewById(R.id.dinosaur_diet_image_detail))
